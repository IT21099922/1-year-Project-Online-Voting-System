...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 09, 2021 at 08:20 AM
...
(16, 'Pamuditha', 'Bandara', 'pamoo@gmail.com', 'pamoo');
...
INSERT INTO `judge` (`JID`, `firstName`, `lastName`, `email`, `password`) VALUES
(1, 'Chamath', 'Liyanage', 'chamath@gmail.com', 'chamath'),
(2, 'Aman', 'Pathmendra', 'aman@gmail.com', 'aman'),
(3, 'Udantha', 'Samarasinghe', 'udantha@gmail.com', 'udantha'),
(4, 'Purnitha', 'Bandara', 'purnitha@gmail.com', 'purnitha'),
(5, 'Pavani', 'Senadheera', 'pavani@gmail.com', 'pavani');
...
(3, 'Gehan', 'Ekanayaka', 0, NULL, 0, '', 'gehan@gmail.com', 'gehan'),
...
(18, 0, NULL, NULL, 3, NULL),
(19, 0, NULL, NULL, 4, NULL),
(20, 0, NULL, NULL, 5, NULL),
...
--
ALTER TABLE `competitors`
  MODIFY `CompID` int(3) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=17;
...
--
ALTER TABLE `reguser`
  MODIFY `regUserID` int(3) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
